...
#define Port 80
#define IPAddr 192,168,2,19   // please note the commas instead of dots!!! Remove this line when you want DHCP
#define GatewayIP 192,168,2,1 // Optional: this is usually your router's IP address. Please note the commas instead of dots!!!
...
//#define MQTTBrokerIP 192,168,2,101	// Please use commas insteaf of dots!!!
//#define MQTTUsername "openhabian" // Set username for MQTT broker here or comment out if no username/password is used.
//#define MQTTPassword "trebor" // Set password for MQTT broker here or comment out if no password is used.
